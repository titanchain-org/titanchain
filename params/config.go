...
var (
	TitanMainnetGenesisHash = common.HexToHash("9326145f8a2c8c00bbe13afc7d7f3d9c868b5ef39d89f2f4e9390e9720298624") // Titan Mainnet genesis hash to enforce below configs on
...
var (
	...
	VicMainnetChainConfig = &ChainConfig{
		...
		TIPTitanXBlock:                big.NewInt(20581700),
		TIPTitanXLendingBlock:         big.NewInt(21430200),
		TIPTitanXCancellationFeeBlock: big.NewInt(30915660),
		Posv: &PosvConfig{
			Period:              2,
			Epoch:               900,
			Reward:              250,
	...
	VicTestnetChainConfig = &ChainConfig{
		...
		TIPTitanXBlock:                big.NewInt(0),
		TIPTitanXLendingBlock:         big.NewInt(0),
		TIPTitanXCancellationFeeBlock: big.NewInt(0),
		Posv: &PosvConfig{
			Period:              2,
			Epoch:               900,
			Reward:              250,
...
type ChainConfig struct {
	...
	TIPTitanXBlock                *big.Int `json:"tipTitanXBlock,omitempty"`                // TIPTitanX switch block (nil = no fork, 0 = already activated)
	TIPTitanXLendingBlock         *big.Int `json:"tipTitanXLendingBlock,omitempty"`         // TIPTitanXLending switch block (nil = no fork, 0 = already activated)
	TIPTitanXCancellationFeeBlock *big.Int `json:"tipTitanXCancellationFeeBlock,omitempty"` // TIPTitanXCancellationFee switch block (nil = no fork, 0 = already activated)
...
func (c *ChainConfig) IsPetersburg(num *big.Int) bool {
	return isForked(common.TIPTitanXCancellationFeeBlock, num)
}
...
func (c *ChainConfig) IsTIPTitanX(num *big.Int) bool {
	return isForked(common.TIPTitanXBlock, num)
}

func (c *ChainConfig) IsTIPTitanXLending(num *big.Int) bool {
	return isForked(common.TIPTitanXLendingBlock, num)
}

func (c *ChainConfig) IsTIPTitanXCancellationFee(num *big.Int) bool {
	return isForked(common.TIPTitanXCancellationFeeBlock, num)
}
...
func (c *ChainConfig) checkCompatible(newcfg *ChainConfig, head *big.Int) *ConfigCompatError {
	...
	if isForkIncompatible(c.TIPTitanXBlock, newcfg.TIPTitanXBlock, head) {
		return newCompatError("TIPTitanX fork block", c.TIPTitanXBlock, newcfg.TIPTitanXBlock)
	}
	if isForkIncompatible(c.TIPTitanXLendingBlock, newcfg.TIPTitanXLendingBlock, head) {
		return newCompatError("TIPTitanXLending fork block", c.TIPTitanXLendingBlock, newcfg.TIPTitanXLendingBlock)
	}
	if isForkIncompatible(c.TIPTitanXCancellationFeeBlock, newcfg.TIPTitanXCancellationFeeBlock, head) {
		return newCompatError("TIPTitanXCancellationFee fork block", c.TIPTitanXCancellationFeeBlock, newcfg.TIPTitanXCancellationFeeBlock)
	}
	return nil
}
...
type Rules struct {
	...
	IsTIPTRC21Fee, IsTIPTitanX, IsTIPTitanXLending          bool
	IsTIPTitanXCancellationFee                              bool
}
...
func (c *ChainConfig) Rules(num *big.Int) Rules {
	...
	return Rules{
		...
		IsTIPTitanX:                c.IsTIPTitanX(num),
		IsTIPTitanXLending:         c.IsTIPTitanXLending(num),
		IsTIPTitanXCancellationFee: c.IsTIPTitanXCancellationFee(num),
	}
}
