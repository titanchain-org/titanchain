...
import (
	...
	"github.com/titanchain/titanchain/core/bloombits"
	...
	"github.com/titanchain/titanchain/eth/filters"
	...
	"github.com/titanchain/titanchain/internal/ethapi"
	"github.com/titanchain/titanchain/log"
	"github.com/titanchain/titanchain/miner"
...
func New(ctx *node.ServiceContext, config *Config, titanXServ *titanx.TitanX, lendingServ *titanxlending.Lending) (*Ethereum, error) {
	...
	// Inject TitanX Service into main Eth Service.
	if titanXServ != nil {
		eth.TitanX = titanXServ
	}
	if lendingServ != nil {
	...
	if eth.chainConfig.Posv != nil {
		...
		c.GetTitanXService = func() posv.TradingService {
			return eth.TitanX
		}
	...
	eth.blockchain, err = core.NewBlockChainEx(chainDb, titanXServ.GetLevelDB(), cacheConfig, eth.chainConfig, eth.engine, vmConfig)
	if err != nil {
		return nil, err
	}
...
func (s *Ethereum) GetTitanX() *titanx.TitanX {
	return s.TitanX
}
...
func (s *Ethereum) GetTitanXLending() *titanxlending.Lending {
	return s.Lending
}
