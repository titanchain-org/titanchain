...
import (
	...
	"github.com/titanchain/titanchain/swarm"
	bzzapi "github.com/titanchain/titanchain/swarm/api"
	swarmmetrics "github.com/titanchain/titanchain/swarm/metrics"
...
func bzzd(ctx *cli.Context) error {
	...
	//titan only supports --datadir via command line
	//in order to be consistent within swarm, if we pass --datadir via environment variable
	//or via config file, we get the same directory for titan and swarm
