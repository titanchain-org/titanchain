...
import (
	...
	"github.com/titanchain/titanchain/accounts/abi/bind/backends"
	blockSignerContract "github.com/titanchain/titanchain/contracts/blocksigner"
	multiSignWalletContract "github.com/titanchain/titanchain/contracts/multisigwallet"
	randomizeContract "github.com/titanchain/titanchain/contracts/randomize"
	vrc25Issuer "github.com/titanchain/titanchain/contracts/trc21issuer"
	validatorContract "github.com/titanchain/titanchain/contracts/validator"
...
func (w *wizard) makeGenesis() {
	...
	case choice == "" || choice == "3":
		...
		fmt.Println()
		fmt.Println("What is swap wallet address for fund 55m titan?")
...
func (w *wizard) manageGenesis() {
	...
	case choice == "1":
		...
		fmt.Println()
		fmt.Printf("Which block should TIP TitanX come into effect? (default = %v)\n", w.conf.Genesis.Config.TIPTitanXBlock)
		w.conf.Genesis.Config.TIPTitanXBlock = w.readDefaultBigInt(w.conf.Genesis.Config.TIPTitanXBlock)

		fmt.Println()
		fmt.Printf("Which block should TIP TitanX Lending come into effect? (default = %v)\n", w.conf.Genesis.Config.TIPTitanXLendingBlock)
		w.conf.Genesis.Config.TIPTitanXLendingBlock = w.readDefaultBigInt(w.conf.Genesis.Config.TIPTitanXLendingBlock)

		fmt.Println()
		fmt.Printf("Which block should TIP TitanX cancellation fee come into effect? (default = %v)\n", w.conf.Genesis.Config.TIPTitanXCancellationFeeBlock)
		w.conf.Genesis.Config.TIPTitanXCancellationFeeBlock = w.readDefaultBigInt(w.conf.Genesis.Config.TIPTitanXCancellationFeeBlock)
