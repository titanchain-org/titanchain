...
var (
	...
	skipNonceDestinationAddress = map[string]bool{
		common.TitanXAddr:                         true,
		common.TradingStateAddr:                   true,
		common.TitanXLendingAddress:               true,
		common.TitanXLendingFinalizedTradeAddress: true,
	}
)
...
func (tx *Transaction) IsTradingTransaction() bool {
	...
	if tx.To().String() != common.TitanXAddr {
		return false
	}
...
func (tx *Transaction) IsLendingTransaction() bool {
	...
	if tx.To().String() != common.TitanXLendingAddress {
		return false
	}
	return true
}
...
func (tx *Transaction) IsLendingFinalizedTradeTransaction() bool {
	...
	if tx.To().String() != common.TitanXLendingFinalizedTradeAddress {
		return false
	}
	return true
}
...
func (tx *Transaction) IsTitanXApplyTransaction() bool {
	if tx.To() == nil {
		return false
	}

	addr := common.TitanXListingSMC
	...
	if method != common.TitanXApplyMethod {
		return false
	}
...
func (tx *Transaction) IsTitanZApplyTransaction() bool {
	if tx.To() == nil {
		return false
	}
	...
	method := common.ToHex(tx.Data()[0:4])
	if method != common.TitanZApplyMethod {
		return false
	}
