...
func TestDefaultGenesisBlock(t *testing.T) {
	...
	if block.Hash() != params.TitanMainnetGenesisHash {
		t.Errorf("wrong mainnet genesis hash, got %v, want %v", block.Hash().String(), params.TitanMainnetGenesisHash.String())
	}
...
func TestSetupGenesis(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			wantHash:   params.TitanMainnetGenesisHash,
