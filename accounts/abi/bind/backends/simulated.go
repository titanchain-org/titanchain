...
import (
	...
	"github.com/titanchain/titanchain"
...
func (b *SimulatedBackend) CallContract(ctx context.Context, call titanchain.CallMsg, blockNumber *big.Int) ([]byte, error) {
	b.mu.Lock()
	defer b.mu.Unlock()
...
func (b *SimulatedBackend) CallContractWithState(call titanchain.CallMsg, chain consensus.ChainContext, statedb *state.StateDB) ([]byte, error) {
...
func (b *SimulatedBackend) PendingCallContract(ctx context.Context, call titanchain.CallMsg) ([]byte, error) {
	b.mu.Lock()
	defer b.mu.Unlock()
...
func (b *SimulatedBackend) EstimateGas(ctx context.Context, call titanchain.CallMsg) (uint64, error) {
	b.mu.Lock()
	defer b.mu.Unlock()
...
func (b *SimulatedBackend) callContract(ctx context.Context, call titanchain.CallMsg, block *types.Block, statedb *state.StateDB) ([]byte, uint64, bool, error) {
	// Ensure message is initialized properly.
...
func (b *SimulatedBackend) FilterLogs(ctx context.Context, query titanchain.FilterQuery) ([]types.Log, error) {
...
func (b *SimulatedBackend) SubscribeFilterLogs(ctx context.Context, query titanchain.FilterQuery, ch chan<- types.Log) (titanchain.Subscription, error) {
