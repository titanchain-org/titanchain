...
import (
	...
	"github.com/titanchain/titanchain/contracts/blocksigner/contract"
	randomizeContract "github.com/titanchain/titanchain/contracts/randomize/contract"
...
func GetRandomizeFromContract(client bind.ContractBackend, addrMasternode common.Address) (int64, error) {
	randomize, err := randomizeContract.NewTitanRandomize(common.HexToAddress(common.RandomizeSMC), client)
	if err != nil {
