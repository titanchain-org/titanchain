...
// TitanXListing is a free data retrieval call binding the contract method 0x29a4ddec.
//
// Solidity: function TitanXListing() constant returns(address)
func (_Lending *LendingCaller) TitanXListing(opts *bind.CallOpts) (common.Address, error) {
	var (
		ret0 = new(common.Address)
	)
	out := ret0
	err := _Lending.contract.Call(opts, out, "TitanXListing")
	return *ret0, err
}
...
//
// Solidity: function TitanXListing() constant returns(address)
func (_Lending *LendingSession) TitanXListing() (common.Address, error) {
	return _Lending.Contract.TitanXListing(&_Lending.CallOpts)
}

// TitanXListing is a free data retrieval call binding the contract method 0x29a4ddec.
//
// Solidity: function TitanXListing() constant returns(address)
func (_Lending *LendingCallerSession) TitanXListing() (common.Address, error) {
	return _Lending.Contract.TitanXListing(&_Lending.CallOpts)
}
