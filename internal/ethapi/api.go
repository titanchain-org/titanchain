...
import (
	...
	"github.com/titanchain/titanchain/accounts"
	"github.com/titanchain/titanchain/accounts/abi/bind"
	"github.com/titanchain/titanchain/accounts/keystore"
	"github.com/titanchain/titanchain/common"
	"github.com/titanchain/titanchain/common/hexutil"
	"github.com/titanchain/titanchain/common/math"
	"github.com/titanchain/titanchain/consensus/ethash"
	"github.com/titanchain/titanchain/consensus/posv"
	contractValidator "github.com/titanchain/titanchain/contracts/validator/contract"
	"github.com/titanchain/titanchain/core"
	"github.com/titanchain/titanchain/core/rawdb"
	"github.com/titanchain/titanchain/core/state"
	"github.com/titanchain/titanchain/core/types"
	"github.com/titanchain/titanchain/core/vm"
	"github.com/titanchain/titanchain/crypto"
	"github.com/titanchain/titanchain/log"
	"github.com/titanchain/titanchain/p2p"
	"github.com/titanchain/titanchain/params"
	"github.com/titanchain/titanchain/rlp"
	"github.com/titanchain/titanchain/rpc"
	"github.com/titanchain/titanchain/titanx/tradingstate"
	"github.com/titanchain/titanchain/titanxlending/lendingstate"
)
...
//
// https://github.com/titanchain/titanchain/wiki/Management-APIs#personal_sign
...
//
// https://github.com/titanchain/titanchain/wiki/Management-APIs#personal_ecRecover
...
func (s *PublicBlockChainAPI) getCandidatesFromSmartContract() ([]posv.Masternode, error) {
	...
	validator, err := contractValidator.NewTitanValidator(addr, client)
	if err != nil {
		return []posv.Masternode{}, err
	}
...
func (s *PublicBlockChainAPI) doCall(ctx context.Context, args CallArgs, blockNr rpc.BlockNumber, vmCfg vm.Config, timeout time.Duration) ([]byte, uint64, bool, error) {
	...
	titanxState, err := s.b.TitanxService().GetTradingState(block, author)
	if err != nil {
		return nil, 0, false, err
	}
	// Get a new instance of the EVM.
	evm, vmError, err := s.b.GetEVM(ctx, msg, statedb, titanxState, header, vmCfg)
	if err != nil {
		return nil, 0, false, err
	}
...
// PublicTransactionPoolAPI exposes methods for the RPC interface
type PublicTitanXTransactionPoolAPI struct {
	b         Backend
	nonceLock *AddrLocker
}
...
// NewPublicTransactionPoolAPI creates a new RPC service with methods specific for the transaction pool.
func NewPublicTitanXTransactionPoolAPI(b Backend, nonceLock *AddrLocker) *PublicTitanXTransactionPoolAPI {
	return &PublicTitanXTransactionPoolAPI{b, nonceLock}
}
...
// The sender is responsible for signing the transaction and using the correct nonce.
func (s *PublicTitanXTransactionPoolAPI) SendOrderRawTransaction(ctx context.Context, encodedTx hexutil.Bytes) (common.Hash, error) {
...
// The sender is responsible for signing the transaction and using the correct nonce.
func (s *PublicTitanXTransactionPoolAPI) SendLendingRawTransaction(ctx context.Context, encodedTx hexutil.Bytes) (common.Hash, error) {
...
func (s *PublicTitanXTransactionPoolAPI) GetOrderTxMatchByHash(ctx context.Context, hash common.Hash) ([]*tradingstate.OrderItem, error) {
	var tx *types.Transaction
...
func (s *PublicTitanXTransactionPoolAPI) GetOrderPoolContent(ctx context.Context) interface{} {
...
func (s *PublicTitanXTransactionPoolAPI) GetOrderStats(ctx context.Context) interface{} {
...
// The sender is responsible for signing the transaction and using the correct nonce.
func (s *PublicTitanXTransactionPoolAPI) SendOrder(ctx context.Context, msg OrderMsg) (common.Hash, error) {
...
// The sender is responsible for signing the transaction and using the correct nonce.
func (s *PublicTitanXTransactionPoolAPI) SendLending(ctx context.Context, msg LendingMsg) (common.Hash, error) {
...
func (s *PublicTitanXTransactionPoolAPI) GetOrderCount(ctx context.Context, addr common.Address) (*hexutil.Uint64, error) {
...
func (s *PublicTitanXTransactionPoolAPI) GetBestBid(ctx context.Context, baseToken, quoteToken common.Address) (PriceVolume, error) {
	...
	titanxService := s.b.TitanxService()
	if titanxService == nil {
		return result, errors.New("TitanX service not found")
	}
	author, err := s.b.GetEngine().Author(block.Header())
	if err != nil {
		return result, err
	}
	titanxState, err := titanxService.GetTradingState(block, author)
	if err != nil {
		return result, err
	}
	result.Price, result.Volume = titanxState.GetBestBidPrice(tradingstate.GetTradingOrderBookHash(baseToken, quoteToken))
...
func (s *PublicTitanXTransactionPoolAPI) GetBestAsk(ctx context.Context, baseToken, quoteToken common.Address) (PriceVolume, error) {
	result := PriceVolume{}
	block := s.b.CurrentBlock()
	if block == nil {
		return result, errors.New("Current block not found")
	...
	result.Price, result.Volume = titanxState.GetBestAskPrice(tradingstate.GetTradingOrderBookHash(baseToken, quoteToken))
	if result.Price.Sign() == 0 {
...
func (s *PublicTitanXTransactionPoolAPI) GetBidTree(ctx context.Context, baseToken, quoteToken common.Address) (map[*big.Int]tradingstate.DumpOrderList, error) {
	block := s.b.CurrentBlock()
	if block == nil {
	...
	titanxService := s.b.TitanxService()
	if titanxService == nil {
		return nil, errors.New("TitanX service not found")
	}
	author, err := s.b.GetEngine().Author(block.Header())
	if err != nil {
		return nil, err
	...
	result, err := titanxState.DumpBidTrie(tradingstate.GetTradingOrderBookHash(baseToken, quoteToken))
	if err != nil {
		return nil, err
	}
	return result, nil
...
func (s *PublicTitanXTransactionPoolAPI) GetPrice(ctx context.Context, baseToken, quoteToken common.Address) (*big.Int, error) {
	block := s.b.CurrentBlock()
	if block == nil {
		return nil, errors.New("Current block not found")
	}
	...
	price := titanxState.GetLastPrice(tradingstate.GetTradingOrderBookHash(baseToken, quoteToken))
...
func (s *PublicTitanXTransactionPoolAPI) GetLastEpochPrice(ctx context.Context, baseToken, quoteToken common.Address) (*big.Int, error) {
	block := s.b.CurrentBlock()
	if block == nil {
		return nil, errors.New("Current block not found")
	}
	...
	price := titanxState.GetMediumPriceBeforeEpoch(tradingstate.GetTradingOrderBookHash(baseToken, quoteToken))
	if price == nil || price.Sign() == 0 {
		return common.Big0, errors.New("Order book's price not found")
	}
	return price, nil
...
func (s *PublicTitanXTransactionPoolAPI) GetCurrentEpochPrice(ctx context.Context, baseToken, quoteToken common.Address) (*big.Int, error) {
	block := s.b.CurrentBlock()
	if block == nil {
		return nil, errors.New("Current block not found")
	}
	...
	price, _ := titanxState.GetMediumPriceAndTotalAmount(tradingstate.GetTradingOrderBookHash(baseToken, quoteToken))
	if price == nil || price.Sign() == 0 {
		return common.Big0, errors.New("Order book's price not found")
	}
	return price, nil
...
func (s *PublicTitanXTransactionPoolAPI) GetAskTree(ctx context.Context, baseToken, quoteToken common.Address) (map[*big.Int]tradingstate.DumpOrderList, error) {
	block := s.b.CurrentBlock()
	if block == nil {
		return nil, errors.New("Current block not found")
	}
	...
	result, err := titanxState.DumpAskTrie(tradingstate.GetTradingOrderBookHash(baseToken, quoteToken))
	if err != nil {
		return nil, err
	}
	return result, nil
...
func (s *PublicTitanXTransactionPoolAPI) GetOrderById(ctx context.Context, baseToken, quoteToken common.Address, orderId uint64) (interface{}, error) {
	block := s.b.CurrentBlock()
	if block == nil {
		return nil, errors.New("Current block not found")
	}
	...
	orderitem := titanxState.GetOrder(tradingstate.GetTradingOrderBookHash(baseToken, quoteToken), orderIdHash)
...
func (s *PublicTitanXTransactionPoolAPI) GetTradingOrderBookInfo(ctx context.Context, baseToken, quoteToken common.Address) (*tradingstate.DumpOrderBookInfo, error) {
	block := s.b.CurrentBlock()
	if block == nil {
		return nil, errors.New("Current block not found")
	}
	...
	result, err := titanxState.DumpOrderBookInfo(tradingstate.GetTradingOrderBookHash(baseToken, quoteToken))
	if err != nil {
		return nil, err
	}
	return result, nil
...
func (s *PublicTitanXTransactionPoolAPI) GetLiquidationPriceTree(ctx context.Context, baseToken, quoteToken common.Address) (map[*big.Int]tradingstate.DumpLendingBook, error) {
	block := s.b.CurrentBlock()
	if block == nil {
		return nil, errors.New("Current block not found")
	}
	...
	result, err := titanxState.DumpLiquidationPriceTrie(tradingstate.GetTradingOrderBookHash(baseToken, quoteToken))
	if err != nil {
		return nil, err
	}
	return result, nil
...
func (s *PublicTitanXTransactionPoolAPI) GetInvestingTree(ctx context.Context, lendingToken common.Address, term uint64) (map[*big.Int]lendingstate.DumpOrderList, error) {
	block := s.b.CurrentBlock()
	if block == nil {
		return nil, errors.New("Current block not found")
	}
	...
	if lendingService == nil {
		return nil, errors.New("TitanX Lending service not found")
	}
	author, err := s.b.GetEngine().Author(block.Header())
	if err != nil {
		return nil, err
...
func (s *PublicTitanXTransactionPoolAPI) GetBorrowingTree(ctx context.Context, lendingToken common.Address, term uint64) (map[*big.Int]lendingstate.DumpOrderList, error) {
	block := s.b.CurrentBlock()
	if block == nil {
		return nil, errors.New("Current block not found")
	}
...
func (s *PublicTitanXTransactionPoolAPI) GetLendingOrderBookInfo(tx context.Context, lendingToken common.Address, term uint64) (*lendingstate.DumpOrderBookInfo, error) {
	block := s.b.CurrentBlock()
	if block == nil {
		return nil, errors.New("Current block not found")
	}
...
func (s *PublicTitanXTransactionPoolAPI) getLendingOrderTree(ctx context.Context, lendingToken common.Address, term uint64) (map[*big.Int]lendingstate.LendingItem, error) {
	block := s.b.CurrentBlock()
	if block == nil {
		return nil, errors.New("Current block not found")
	}
...
func (s *PublicTitanXTransactionPoolAPI) GetLendingTradeTree(ctx context.Context, lendingToken common.Address, term uint64) (map[*big.Int]lendingstate.LendingTrade, error) {
	block := s.b.CurrentBlock()
	if block == nil {
		return nil, errors.New("Current block not found")
	}
...
func (s *PublicTitanXTransactionPoolAPI) GetLiquidationTimeTree(ctx context.Context, lendingToken common.Address, term uint64) (map[*big.Int]lendingstate.DumpOrderList, error) {
	block := s.b.CurrentBlock()
	if block == nil {
		return nil, errors.New("Current block not found")
	}
...
func (s *PublicTitanXTransactionPoolAPI) GetLendingOrderCount(ctx context.Context, addr common.Address) (*hexutil.Uint64, error) {
	block := s.b.CurrentBlock()
	if block == nil {
		return nil, errors.New("Current block not found")
	}
...
func (s *PublicTitanXTransactionPoolAPI) GetBestInvesting(ctx context.Context, lendingToken common.Address, term uint64) (InterestVolume, error) {
	...
	lendingService := s.b.LendingService()
	if lendingService == nil {
		return result, errors.New("TitanX Lending service not found")
	}
	author, err := s.b.GetEngine().Author(block.Header())
	if err != nil {
		return result, err
...
func (s *PublicTitanXTransactionPoolAPI) GetBestBorrowing(ctx context.Context, lendingToken common.Address, term uint64) (InterestVolume, error) {
	result := InterestVolume{}
	block := s.b.CurrentBlock()
	if block == nil {
		return result, errors.New("Current block not found")
...
func (s *PublicTitanXTransactionPoolAPI) GetBids(ctx context.Context, baseToken, quoteToken common.Address) (map[*big.Int]*big.Int, error) {
	block := s.b.CurrentBlock()
	if block == nil {
		return nil, errors.New("Current block not found")
	}
	...
	result, err := titanxState.GetBids(tradingstate.GetTradingOrderBookHash(baseToken, quoteToken))
	if err != nil {
		return nil, err
	}
	return result, nil
...
func (s *PublicTitanXTransactionPoolAPI) GetAsks(ctx context.Context, baseToken, quoteToken common.Address) (map[*big.Int]*big.Int, error) {
	block := s.b.CurrentBlock()
	if block == nil {
		return nil, errors.New("Current block not found")
	}
	...
	result, err := titanxState.GetAsks(tradingstate.GetTradingOrderBookHash(baseToken, quoteToken))
	if err != nil {
		return nil, err
	}
	return result, nil
...
func (s *PublicTitanXTransactionPoolAPI) GetInvests(ctx context.Context, lendingToken common.Address, term uint64) (map[*big.Int]*big.Int, error) {
	block := s.b.CurrentBlock()
	if block == nil {
		return nil, errors.New("Current block not found")
	}
...
func (s *PublicTitanXTransactionPoolAPI) GetBorrows(ctx context.Context, lendingToken common.Address, term uint64) (map[*big.Int]*big.Int, error) {
	block := s.b.CurrentBlock()
	if block == nil {
		return nil, errors.New("Current block not found")
	}
...
func (s *PublicTitanXTransactionPoolAPI) GetLendingTxMatchByHash(ctx context.Context, hash common.Hash) ([]*lendingstate.LendingItem, error) {
	var tx *types.Transaction
	if tx, _, _, _ = rawdb.GetTransaction(s.b.ChainDb(), hash); tx == nil {
		if tx = s.b.GetPoolTransaction(hash); tx == nil {
...
// GetLiquidatedTradesByTxHash returns trades which closed by TitanX protocol at the tx of the give hash
func (s *PublicTitanXTransactionPoolAPI) GetLiquidatedTradesByTxHash(ctx context.Context, hash common.Hash) (lendingstate.FinalizedResult, error) {
	var tx *types.Transaction
	if tx, _, _, _ = rawdb.GetTransaction(s.b.ChainDb(), hash); tx == nil {
		if tx = s.b.GetPoolTransaction(hash); tx == nil {
...
func (s *PublicTitanXTransactionPoolAPI) GetLendingOrderById(ctx context.Context, lendingToken common.Address, term uint64, orderId uint64) (lendingstate.LendingItem, error) {
	...
	lendingService := s.b.LendingService()
	if lendingService == nil {
		return lendingItem, errors.New("TitanX Lending service not found")
	}
	author, err := s.b.GetEngine().Author(block.Header())
	if err != nil {
...
func (s *PublicTitanXTransactionPoolAPI) GetLendingTradeById(ctx context.Context, lendingToken common.Address, term uint64, tradeId uint64) (lendingstate.LendingTrade, error) {
