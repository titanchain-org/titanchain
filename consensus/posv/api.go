...
type NetworkInformation struct {
	NetworkId                  *big.Int
	TitanValidatorAddress      common.Address
	RelayerRegistrationAddress common.Address
	TitanXListingAddress       common.Address
	TitanZAddress              common.Address
...
func (api *API) NetworkInformation() NetworkInformation {
	...
	info.TitanValidatorAddress = common.HexToAddress(common.MasternodeVotingSMC)
	...
	info.TitanXListingAddress = common.TitanXListingSMC
	info.TitanZAddress = common.TRC21IssuerSMC
	return info
}
