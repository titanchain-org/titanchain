...
import (
	...
	"github.com/titanchain/titanchain/consensus/clique"
...
type TradingService interface {
	...
	ApplyOrder(header *types.Header, coinbase common.Address, chain consensus.ChainContext, statedb *state.StateDB, titanXstatedb *tradingstate.TradingStateDB, orderBook common.Hash, order *tradingstate.OrderItem) ([]map[string]string, []*tradingstate.OrderItem, error)
...
type Posv struct {
	...
	GetTitanXService           func() TradingService
