...
import (
	...
	"github.com/titanchain/titanchain/console/prompt"
	"github.com/titanchain/titanchain/internal/jsre"
	"github.com/titanchain/titanchain/internal/jsre/deps"
	"github.com/titanchain/titanchain/internal/web3ext"
...
func (c *Console) Welcome() {
	// Print some generic Titan metadata
	fmt.Fprintf(c.printer, "Welcome to the Titan JavaScript console!\n\n")
	c.jsre.Run(`
