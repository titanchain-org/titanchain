...
import (
	...
	"github.com/titanchain/titanchain/light"
...
func (b *LesApiBackend) GetEVM(ctx context.Context, msg core.Message, state *state.StateDB, titanxState *tradingstate.TradingStateDB, header *types.Header, vmCfg vm.Config) (*vm.EVM, func() error, error) {
	state.SetBalance(msg.From(), math.MaxBig256)
	context := core.NewEVMContext(msg, header, b.eth.blockchain, nil)
	return vm.NewEVM(context, state, titanxState, b.eth.chainConfig, vmCfg), state.Error, nil
}
...
func (b *LesApiBackend) TitanxService() *titanx.TitanX {
	return nil
}

func (b *LesApiBackend) LendingService() *titanxlending.Lending {
	return nil
}
