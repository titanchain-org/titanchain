...
var TIPTitanXBlock = big.NewInt(20581700)
var TIPTitanXLendingBlock = big.NewInt(21430200)
var TIPTitanXCancellationFeeBlock = big.NewInt(30915660)
...
var TitanXBaseFee = big.NewInt(10000)                                     // 1 / TitanXBaseFee
var RelayerCancelFee = big.NewInt(100000000000000)                        // 0.0001
var TitanXBaseCancelFee = new(big.Int).Mul(TitanXBaseFee, big.NewInt(10)) // 1/ (TitanXBaseFee *10)
...
var TitanXListingSMC = HexToAddress("0xDE34dD0f536170993E8CFF639DdFfCF1A85D3E53")
var TitanXListingSMCTestNet = HexToAddress("0x14B2Bf043b9c31827A472CE4F94294fE9a6277e0")
